...
###  Clone with HTTPS:
```
 git clone https://github.com/ismailtasdelen/command-injection-payload-list.git
```

### Clone with SSH:
```
git clone git@github.com:ismailtasdelen/command-injection-payload-list.git
```
