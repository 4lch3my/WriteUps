...
And finally, we have a `MySQL` database running on `port 3306`. If you need a `MySQL` database reader software for your machine, you can install the official MySQL client like this: `sudo apt-get install mysql-client-core-5.7`. 
